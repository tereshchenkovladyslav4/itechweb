...
const PieTaskOutcome: React.FC<IFilteredChartProps> = ({ service, area, filterData, onChartMenuSelected, chartIndex }: IFilteredChartProps) => {
    ...
    return (
            <ChartMenuWrapper Chart={PieChart} callback={onChartMenuSelected} opt={{ area: area,  dataKey: "description", data: data, dataValue: datavalue, seriesName:"outcomeTypeDescription", title:"Task count by outcome", chartIndex: chartIndex }} />
    );
}

PieTaskOutcome.displayName = "PieTaskOutcome";

export default PieTaskOutcome;