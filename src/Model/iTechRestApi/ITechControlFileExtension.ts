...
import { ITechControlContentType } from "./ITechControlContentType";



export class ITechControlFileExtension {
    ...
    public iTechControlContentTypeRowId: number | null;
    public iTechControlContentTypeRow: ITechControlContentType;
}
