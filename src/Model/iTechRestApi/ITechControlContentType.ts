...
import { ITechControlFileExtension } from "./ITechControlFileExtension";



export class ITechControlContentType {
    ...
    public iTechControlFileExtensions: ITechControlFileExtension[];
}
