...
import { ITechControlCharacterSetAlia } from "./ITechControlCharacterSetAlia";



export class ITechControlCharacterSetType {
    ...
    public mibenum: number | null;
    public iTechControlCharacterSetAlias: ITechControlCharacterSetAlia[];
}
